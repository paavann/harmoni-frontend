            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-3">
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className="ml-auto text-sm underline-offset-2 hover:underline text-green-400 font-bold"
                  >
              ...
              <div className="text-center text-sm">
                ...
                <a href="create-account" className="underline underline-offset-4 text-green-400 font-bold">
                  Sign up
                </a>
              </div>
            </div>
